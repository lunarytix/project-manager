...
describe('UsersController', () => {
    ...
    const controller = new users_controller_1.UsersController(usersService);
    beforeEach(() => {
        jest.clearAllMocks();
    });
    ...
    it('should reject upload when file is missing', async () => {
        await expect(controller.uploadPhoto('1', undefined)).rejects.toBeInstanceOf(common_1.BadRequestException);
    });
});
